...
namespace RailroadStationVisualizer.App.Model
{
    public class StationSchemaProvider : IStationSchemaProvider
    {
        ...
        private static RailwayTrack[] GetRailwayTracks(RailwayPoint[] points) {
            ...
            var park1 = "Парк 1";
            var railwayTrack1 = new RailwayTrack(new[] {
            ...
            var railwayTrack2 = new RailwayTrack(new[] {
                new RailwaySection(index++, points[2], points[5])
            }, park1);

            var railwayTrack3 = new RailwayTrack(new[] {
            ...
            var railwayTrack9 = new RailwayTrack(new[] {
                new RailwaySection(index++, points[23], points[10]),
            });

            var railwayTrack10 = new RailwayTrack(new[] {
            ...
            var railwayTrack19 = new RailwayTrack(new[] {
            ...
            var railwayTrack20 = new RailwayTrack(new[] {
                new RailwaySection(index++, points[40], points[41]),
            }, park2);

            var railwayTrack21 = new RailwayTrack(new[] {
            ...
            var railwayTrack22 = new RailwayTrack(new[] {
